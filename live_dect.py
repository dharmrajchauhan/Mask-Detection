...
class live_detection(MainWindow):
    def stop_cam(self):
    ...
    def display_image(self):
        ...
        while(cap.isOpened()):
            ...
            if (self.logic == 1):
                try:
                    ...
                    for i in range(0, detections.shape[2]):
                        ...
                        if confidence > 0.5:
                            ...
                            faces = ([live_detection.prepare(faces)])
                ...
                self.ui.live_output.setPixmap(QPixmap.fromImage(simg))
                self.ui.live_output.setAlignment(QtCore.Qt.AlignHCenter | QtCore.Qt.AlignVCenter)                
                self.ui.live_error.setText("Detection work completely")
